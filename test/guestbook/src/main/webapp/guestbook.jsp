...
if (phone==null || phone==""){  
 ...
 if(delay==null || delay=="" || parseInt(delay)<0){  
  alert("Wrong input for delay or delay is blank. Please correct the input.");  
  return false;  
  }  
}  
...
<form action="/twiml" name="my" method="post" onsubmit="return validateform()">
	...
	<br>
	<div><label>Delay Time(In seconds):</label></div> 
    <div><input type="text" name="delay" /></div>
	<br>
